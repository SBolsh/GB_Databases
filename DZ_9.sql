...
(NULL, 'first', '2018-08-01'),
(NULL, 'second', '2018-08-04'),
(NULL, 'third', '2018-08-16'),
(NULL, 'fourth', '2018-08-17');
...
LEFT JOIN
  posts
ON
  DATE(DATE('2018-08-31') - INTERVAL l.day DAY) = posts.created_at
ORDER BY
  day;
...
INSERT INTO posts VALUES
(NULL, 'fifth', '2018-08-05'),
(NULL, 'sixth', '2018-08-06'),
(NULL, 'seventh', '2018-08-07'),
(NULL, 'eighth', '2018-08-08'),
(NULL, 'nineth', '2018-08-09'),
(NULL, 'tenth', '2018-08-10');
...
--- Задание 4.Создайте двух пользователей которые имеют доступ к базе данных shop.
--- Первому пользователю shop_read должны быть доступны только запросы на чтение данных,
--- второму пользователю shop — любые операции в пределах базы данных shop.

CREATE USER 'shop_readall'@'localhost';
GRANT SELECT, SHOW VIEW ON shop.* TO 'shop_readall'@'localhost' IDENTIFIED BY '';

CREATE USER 'shop_admin'@'localhost';
GRANT ALL ON shop.* TO 'shop_admin'@'localhost' IDENTIFIED BY '';


--- Задние 5. Пусть имеется таблица accounts содержащая три столбца id, name, password,
...
--- Задание 5.Создайте хранимую функцию hello(), которая будет возвращать приветствие,
...
--- Задание 6.В таблице products есть два текстовых поля: name с названием товара и
...
--- Задание 7.Напишите хранимую функцию для вычисления произвольного числа Фибоначчи. 
